    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          // Right drawer
          'data-[vaul-drawer-direction=right]:inset-y-0 data-[vaul-drawer-direction=right]:right-0 data-[vaul-drawer-direction=right]:w-3/4 data-[vaul-drawer-direction=right]:sm:max-w-sm data-[vaul-drawer-direction=right]:rounded-l-lg data-[vaul-drawer-direction=right]:border-l',

          // Left drawer
          'data-[vaul-drawer-direction=left]:inset-y-0 data-[vaul-drawer-direction=left]:left-0 data-[vaul-drawer-direction=left]:w-3/4 data-[vaul-drawer-direction=left]:sm:max-w-sm data-[vaul-drawer-direction=left]:rounded-r-lg data-[vaul-drawer-direction=left]:border-r',

          className
        )}
        {...props}>
        {/* Drag handle only for top/bottom drawers */}
        <div className={cn('bg-muted mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full', 'group-data-[vaul-drawer-direction=bottom]/drawer-content:block', 'group-data-[vaul-drawer-direction=top]/drawer-content:block')} />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
